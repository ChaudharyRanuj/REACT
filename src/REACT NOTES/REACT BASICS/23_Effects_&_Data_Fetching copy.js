...
// USE EFFECTS TO INTERACT WITH METHODS OUTSIDE COMPONENT 
useEffect( function () {
async function fetchMovie() {
  setIsLoading(true)
  const res = await fetch(`http://www.omdbapi.com/?i=tt3896198&apikey=571f166&s=galaxy`)

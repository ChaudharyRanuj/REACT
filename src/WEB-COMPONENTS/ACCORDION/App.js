...
function Accordion({data}) {
  ...
  return <div className="accordion">
    {data.map((ele, i)=> <AccordionItem active={active} onActive={handleActive} num={i} title={ele.title} text={ele.text}  key={ele.title}/> )}
  </div>;
}
...
//   setIsOpen(!isOpen)
// }
return (<div className={`item ${num === active ? 'open' : ''}`} onClick={()=>{onActive(num)}}>
